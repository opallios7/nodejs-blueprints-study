(function() {
      ...
      return (
        <div className="card">
          ...
          <div className="card-block">
            <h4 calssName="card-title">{this.props.make}</h4>
  ...
  var MotorcycleBox = React.createClass({
    ...
    componentDidMount: function() {
      this.laodMotorcyclesFromServer();
    },
    render: function() {
      return (
        <div>
  ...
  var MotorcycleList = React.createClass({
    render: function() {
      var motorcycleNodes = this.props.data.map(function(motorcycle)
      {
        ...
        return (
          <Motorcycle image={motorcycle.image} make={motorcycle.make} model={motorcycle.model} description={motorcycle.description}
